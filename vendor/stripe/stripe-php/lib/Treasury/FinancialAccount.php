...
namespace Churnsolution\Stripe\Treasury;
 ...
 * @property \Churnsolution\Stripe\StripeObject $balance Balance information for the FinancialAccount
 ...
 * @property null|\Churnsolution\Stripe\Treasury\FinancialAccountFeatures $features Encodes whether a FinancialAccount has access to a particular Feature, with a <code>status</code> enum and associated <code>status_details</code>. Stripe or the platform can control Features via the requested field.
 * @property \Churnsolution\Stripe\StripeObject[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property \Churnsolution\Stripe\StripeObject $status_details
 ...
 */
class FinancialAccount extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Treasury\FinancialAccount the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Treasury\FinancialAccount> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Treasury\FinancialAccount
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Treasury\FinancialAccount the updated resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Treasury\FinancialAccountFeatures the retrieved financial account features
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Treasury\FinancialAccountFeatures the updated financial account features
     */
