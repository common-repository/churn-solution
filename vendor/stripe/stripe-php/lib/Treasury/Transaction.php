 ...
 * @property \Churnsolution\Stripe\StripeObject $balance_impact Change to a FinancialAccount's balance
 ...
 * @property null|\Churnsolution\Stripe\Collection<\Stripe\Treasury\TransactionEntry> $entries A list of TransactionEntries that are part of this Transaction. This cannot be expanded in any list endpoints.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $flow_details Details of the flow that created the Transaction.
...
class Transaction extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Treasury\Transaction> of ApiResources
     */
