 ...
 * @property null|\Churnsolution\Stripe\StripeObject $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property \Churnsolution\Stripe\StripeObject $linked_flows
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property null|string|\Churnsolution\Stripe\Treasury\Transaction $transaction The Transaction associated with this object.
 */
class InboundTransfer extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Treasury\InboundTransfer the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Treasury\InboundTransfer> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Treasury\InboundTransfer the canceled inbound transfer
     */
