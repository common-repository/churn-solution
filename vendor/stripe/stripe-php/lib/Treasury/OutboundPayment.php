 ...
 * @property null|\Churnsolution\Stripe\StripeObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\Churnsolution\Stripe\StripeObject $end_user_details Details about the end user.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $tracking_details Details about network-specific tracking information if available.
 * @property string|\Churnsolution\Stripe\Treasury\Transaction $transaction The Transaction associated with this object.
 */
class OutboundPayment extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Treasury\OutboundPayment the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Treasury\OutboundPayment> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Treasury\OutboundPayment
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Treasury\OutboundPayment the canceled outbound payment
     */
