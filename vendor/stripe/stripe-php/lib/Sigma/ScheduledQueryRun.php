...
namespace Churnsolution\Stripe\Sigma;
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $error
 * @property null|\Churnsolution\Stripe\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Sigma\ScheduledQueryRun> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Sigma\ScheduledQueryRun
     */
