 ...
 * @property null|string|\Churnsolution\Stripe\Charge $charge ID of the charge that's refunded.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $destination_details
 * @property null|string|\Churnsolution\Stripe\BalanceTransaction $failure_balance_transaction After the refund fails, this balance transaction describes the adjustment made on your account balance that reverses the initial balance transaction.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $next_action
 * @property null|string|\Churnsolution\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's refunded.
 ...
 * @property null|string|\Churnsolution\Stripe\TransferReversal $source_transfer_reversal The transfer reversal that's associated with the refund. Only present if the charge came from another Stripe account.
 ...
 * @property null|string|\Churnsolution\Stripe\TransferReversal $transfer_reversal This refers to the transfer reversal object if the accompanying transfer reverses. This is only applicable if the charge was created using the destination parameter.
 */
class Refund extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Refund the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Refund> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Refund the updated resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Refund the canceled refund
     */
