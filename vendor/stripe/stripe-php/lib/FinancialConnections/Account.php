...
namespace Churnsolution\Stripe\FinancialConnections;
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\Churnsolution\Stripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\Churnsolution\Stripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\Churnsolution\Stripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\Churnsolution\Stripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\FinancialConnections\Account> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\FinancialConnections\Account
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\FinancialConnections\AccountOwner> list of account owners
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\FinancialConnections\Account the refreshed account
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\FinancialConnections\Account the subscribed account
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\FinancialConnections\Account the unsubscribed account
     */
