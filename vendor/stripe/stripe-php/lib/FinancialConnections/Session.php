 ...
 * @property null|\Churnsolution\Stripe\StripeObject $account_holder The account holder for whom accounts are collected in this session.
 * @property \Churnsolution\Stripe\Collection<\Stripe\FinancialConnections\Account> $accounts The accounts that were collected as part of this Session.
 * @property string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|\Churnsolution\Stripe\StripeObject $filters
...
class Session extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\FinancialConnections\Session the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\FinancialConnections\Session
     */
