 ...
 * @property \Churnsolution\Stripe\StripeObject $after_completion
 * @property bool $allow_promotion_codes Whether user redeemable promotion codes are enabled.
 * @property null|string|\Churnsolution\Stripe\Application $application The ID of the Connect application that created the Payment Link.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $consent_collection When set, provides configuration to gather active consent from customers.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $invoice_creation Configuration for creating invoice for payment mode payment links.
 * @property null|\Churnsolution\Stripe\Collection<\Stripe\LineItem> $line_items The line items representing what is being sold.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $payment_intent_data Indicates the parameters to be passed to PaymentIntent creation during checkout.
 ...
 * @property \Churnsolution\Stripe\StripeObject $phone_number_collection
 * @property null|\Churnsolution\Stripe\StripeObject $restrictions Settings that restrict the usage of a payment link.
 * @property null|\Churnsolution\Stripe\StripeObject $shipping_address_collection Configuration for collecting the customer's shipping address.
 * @property \Churnsolution\Stripe\StripeObject[] $shipping_options The shipping rate options applied to the session.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $subscription_data When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use <code>subscription_data</code>.
 * @property \Churnsolution\Stripe\StripeObject $tax_id_collection
 * @property null|\Churnsolution\Stripe\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to.
...
class PaymentLink extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\PaymentLink the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\PaymentLink> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\PaymentLink
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\PaymentLink the updated resource
     */
