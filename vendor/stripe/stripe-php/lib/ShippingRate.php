 ...
 * @property null|\Churnsolution\Stripe\StripeObject $delivery_estimate The estimated range for how long shipping will take, meant to be displayable to the customer. This will appear on CheckoutSessions.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $fixed_amount
 ...
 * @property null|string|\Churnsolution\Stripe\TaxCode $tax_code A <a href="https://stripe.com/docs/tax/tax-categories">tax code</a> ID. The Shipping tax code is <code>txcd_92010001</code>.
...
class ShippingRate extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\ShippingRate the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\ShippingRate> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\ShippingRate
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\ShippingRate the updated resource
     */
