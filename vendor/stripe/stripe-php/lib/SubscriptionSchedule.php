 ...
 * @property null|string|\Churnsolution\Stripe\Application $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\Churnsolution\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \Churnsolution\Stripe\StripeObject $default_settings
 ...
 * @property \Churnsolution\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\Churnsolution\Stripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\Churnsolution\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\SubscriptionSchedule the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\SubscriptionSchedule> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\SubscriptionSchedule
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\SubscriptionSchedule the updated resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\SubscriptionSchedule the released subscription schedule
     */
