 ...
 * @property \Churnsolution\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Stripe account as a result of this dispute.
 * @property string|\Churnsolution\Stripe\Charge $charge ID of the charge that's disputed.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property \Churnsolution\Stripe\StripeObject $evidence
 * @property \Churnsolution\Stripe\StripeObject $evidence_details
 ...
 * @property null|string|\Churnsolution\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\Churnsolution\Stripe\StripeObject $payment_method_details
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Dispute> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Dispute
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Dispute the updated resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Dispute the closed dispute
     */
