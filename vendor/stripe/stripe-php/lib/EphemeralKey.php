...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\EphemeralKey the deleted resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \Churnsolution\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\EphemeralKey the created key
     */
