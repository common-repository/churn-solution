 ...
 * @property null|\Churnsolution\Stripe\StripeObject $document Result from a document check
 * @property null|\Churnsolution\Stripe\StripeObject $email Result from a email check
 * @property null|\Churnsolution\Stripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\Churnsolution\Stripe\StripeObject $options
 * @property null|\Churnsolution\Stripe\StripeObject $phone Result from a phone check
 * @property null|\Churnsolution\Stripe\StripeObject $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Identity\VerificationReport> of ApiResources
     */
