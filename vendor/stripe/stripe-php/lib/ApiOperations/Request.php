...
trait Request
{
     ...
     *
     * @throws \Churnsolution\Stripe\Exception\InvalidArgumentException if $params exists and is not an array
     */
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            $message = 'You must pass an array as the first argument to Stripe API '
                ...
                . "would be: \"Churnsolution\\Stripe\\Charge::create(['amount' => 100, "
                . "'currency' => 'usd', 'source' => 'tok_1234'])\")";

            throw new \Churnsolution\Stripe\Exception\InvalidArgumentException($message);
        }
    }
    ...
    /**
     * @param string $url URL for the request
     * @param class-string< \Stripe\SearchResult|\Churnsolution\Stripe\Collection > $resultClass indicating what type of paginated result is returned
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection|\Churnsolution\Stripe\SearchResult
     */
    protected static function _requestPage($url, $resultClass, $params = null, $options = null, $usage = [])
    {
        ...
        if (!($obj instanceof $resultClass)) {
            throw new \Churnsolution\Stripe\Exception\UnexpectedValueException(
    ...
    {
        $opts = \Churnsolution\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \Churnsolution\Stripe\ApiRequestor($opts->apiKey, $baseUrl);
