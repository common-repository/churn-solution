...
namespace Churnsolution\Stripe\HttpClient;

use Churnsolution\Stripe\Exception;
use Churnsolution\Stripe\Stripe;
use Churnsolution\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \Churnsolution\Stripe\Util\RandomGenerator */
     ...
     * @param null|\Churnsolution\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\Churnsolution\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
