 ...
 * @property \Churnsolution\Stripe\StripeObject $restrictions
...
class PromotionCode extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\PromotionCode the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\PromotionCode> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\PromotionCode
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\PromotionCode the updated resource
     */
