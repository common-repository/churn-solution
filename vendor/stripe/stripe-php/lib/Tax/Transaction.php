 ...
 * @property null|\Churnsolution\Stripe\Collection<\Stripe\Tax\TransactionLineItem> $line_items The tax collected or refunded, by line item.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $reversal If <code>type=reversal</code>, contains information about what was reversed.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $shipping_cost The shipping cost details for the transaction.
...
class Transaction extends \Churnsolution\Stripe\ApiResource
{
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Tax\Transaction the created transaction
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Tax\TransactionLineItem> list of transaction line items
     */
