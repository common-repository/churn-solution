 ...
 * @property null|string|\Churnsolution\Stripe\Application $application ID of the Connect Application that created the configuration.
 * @property \Churnsolution\Stripe\StripeObject $business_profile
 ...
 * @property \Churnsolution\Stripe\StripeObject $login_page
...
class Configuration extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\BillingPortal\Configuration the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\BillingPortal\Configuration> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\BillingPortal\Configuration
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\BillingPortal\Configuration the updated resource
     */
