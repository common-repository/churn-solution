...
namespace Churnsolution\Stripe\Billing;
 ...
 * @property \Churnsolution\Stripe\StripeObject $customer_mapping
 * @property \Churnsolution\Stripe\StripeObject $default_aggregation
 ...
 * @property \Churnsolution\Stripe\StripeObject $value_settings
 */
class Meter extends \Churnsolution\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';

    use \Churnsolution\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \Churnsolution\Stripe\Billing\Meter the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Billing\Meter> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Billing\Meter
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Billing\Meter the updated resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Billing\Meter the deactivated meter
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Billing\Meter the reactivated meter
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Billing\MeterEventSummary> the list of meter event summaries
     */
