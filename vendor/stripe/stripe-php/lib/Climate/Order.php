...
namespace Churnsolution\Stripe\Climate;
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $beneficiary
 ...
 * @property \Churnsolution\Stripe\StripeObject[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 * @property string|\Churnsolution\Stripe\Climate\Product $product Unique ID for the Climate <code>Product</code> this order is purchasing.
 ...
 */
class Order extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Climate\Order the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Climate\Order> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Climate\Order
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Climate\Order the updated resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Climate\Order the canceled order
     */
