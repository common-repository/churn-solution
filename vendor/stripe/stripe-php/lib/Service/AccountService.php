 ...
 */
class AccountService extends \Churnsolution\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Account>
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Capability>
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\BankAccount|\Churnsolution\Stripe\Card>
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Person>
     */
