 ...
 */
class SubscriptionService extends \Churnsolution\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Subscription>
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Subscription
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\SearchResult<\Stripe\Subscription>
     */
