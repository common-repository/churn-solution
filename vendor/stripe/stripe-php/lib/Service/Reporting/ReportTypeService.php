...
namespace Churnsolution\Stripe\Service\Reporting;

/**
 * @phpstan-import-type RequestOptionsArray from \Stripe\Util\RequestOptions
 * @psalm-import-type RequestOptionsArray from \Stripe\Util\RequestOptions
 */
class ReportTypeService extends \Churnsolution\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Reporting\ReportType>
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Reporting\ReportType
     */
