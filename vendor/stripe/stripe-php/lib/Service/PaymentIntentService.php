 ...
 */
class PaymentIntentService extends \Churnsolution\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\PaymentIntent>
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\PaymentIntent
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\SearchResult<\Stripe\PaymentIntent>
     */
