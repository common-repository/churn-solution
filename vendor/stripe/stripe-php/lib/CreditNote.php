 ...
 * @property string|\Churnsolution\Stripe\Customer $customer ID of the customer.
 * @property null|string|\Churnsolution\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property \Churnsolution\Stripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 ...
 * @property string|\Churnsolution\Stripe\Invoice $invoice ID of the invoice.
 * @property \Churnsolution\Stripe\Collection<\Stripe\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|string|\Churnsolution\Stripe\Refund $refund Refund related to this credit note.
 * @property null|\Churnsolution\Stripe\StripeObject $shipping_cost The details of the cost of shipping, including the ShippingRate applied to the invoice.
 ...
 * @property \Churnsolution\Stripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\CreditNote the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\CreditNote> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\CreditNote
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\CreditNote the updated resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\CreditNoteLineItem> list of credit note line items
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\CreditNote the voided credit note
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\CreditNoteLineItem> the list of credit note line items
     */
