 ...
 * @property null|\Churnsolution\Stripe\StripeObject $additional_tos_acceptances
 * @property null|\Churnsolution\Stripe\StripeObject $address
 * @property null|\Churnsolution\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\Churnsolution\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|\Churnsolution\Stripe\StripeObject $dob
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for this person</a>, including what information needs to be collected, and by when.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $registered_address
 * @property null|\Churnsolution\Stripe\StripeObject $relationship
 * @property null|\Churnsolution\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property null|\Churnsolution\Stripe\StripeObject $verification
 */
class Person extends ApiResource
{
     ...
     *
     * @throws \Churnsolution\Stripe\Exception\BadMethodCallException
     */
