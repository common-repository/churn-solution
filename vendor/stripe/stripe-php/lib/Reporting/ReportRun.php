...
namespace Churnsolution\Stripe\Reporting;
 ...
 * @property \Churnsolution\Stripe\StripeObject $parameters
 ...
 * @property null|\Churnsolution\Stripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Reporting\ReportRun the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Reporting\ReportRun> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Reporting\ReportRun
     */
