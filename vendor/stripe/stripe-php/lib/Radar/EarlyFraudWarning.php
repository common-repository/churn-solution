 ...
 * @property string|\Churnsolution\Stripe\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property null|string|\Churnsolution\Stripe\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \Churnsolution\Stripe\ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\Radar\EarlyFraudWarning> of ApiResources
     */
