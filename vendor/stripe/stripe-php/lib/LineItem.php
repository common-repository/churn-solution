 ...
 * @property null|\Churnsolution\Stripe\StripeObject[] $discounts The discounts applied to the line item.
 * @property null|\Churnsolution\Stripe\Price $price The price used to generate the line item.
 * @property null|int $quantity The quantity of products being purchased.
 * @property null|\Churnsolution\Stripe\StripeObject[] $taxes The taxes applied to the line item.
 */
