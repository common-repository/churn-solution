 ...
 * @property string|\Churnsolution\Stripe\File $file The file object this link points to.
...
class FileLink extends ApiResource
{
     ...
     *
     * @return \Churnsolution\Stripe\FileLink the created resource
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\Collection<\Stripe\FileLink> of ApiResources
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\FileLink
     */
     ...
     * @throws \Churnsolution\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Churnsolution\Stripe\FileLink the updated resource
     */
